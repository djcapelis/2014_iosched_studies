...
int main()
{
    ...
    printf("Test 1:\n");
    pthread_create(&t[0], NULL, L3_test, (void *) MM_LEN);
    ...
    printf("Test 6:\n");
    pthread_create(&t[0], NULL, L3_test, (void *) MM_LEN);
    pthread_create(&t[1], NULL, L3_test, (void *) MM_LEN);
    pthread_create(&t[2], NULL, L3_test, (void *) MM_LEN);
    L3_test((void *) MM_LEN);
    pthread_join(t[0], NULL);
    pthread_join(t[1], NULL);
    pthread_join(t[2], NULL);
    printf("Test 7:\n");
    pthread_create(&t[0], NULL, L2_test, (void *) (MM_LEN*5));
    pthread_create(&t[1], NULL, L3_test, (void *) MM_LEN);
